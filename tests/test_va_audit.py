...
_PHYSICS_FUNCTION_VA_MACROS = frozenset({
    ...
    "AZURIK_FUN_FALL_DEATH_DISPATCH_VA",
    "AZURIK_FUN_PLAYER_LANDING_VA",
    "AZURIK_FUN_APPLY_DAMAGE_VA",
    ...
    # Late April 2026 shim-revival function anchors.
...
_PHYSICS_PATCH_SITE_VA_MACROS = frozenset({
    ...
    "AZURIK_PATCH_PEAK_Z_FADD_VA",
    "AZURIK_PATCH_FLAP_FLD_VA",
    "AZURIK_PATCH_FLAP_SUB_FMUL_VA",
    "AZURIK_PATCH_FLAP_DESCENT_FUEL_VA",
    "AZURIK_PATCH_FLAP_ENTRY_FUEL_VA",
    "AZURIK_PATCH_FLAP_AT_PEAK_FLD_ST_VA",
    ...
    "AZURIK_SHIM_HOOK_ANIM_APPLY_VTABLE_VA",
